...
export default function LaboratoryTab({ employee }: HealthTabProps){
 ...
 const get=(x:any)=>{const raw=x?.raw_json||{}; const v=raw.laboratory||raw.lab||raw.laboratuvar||raw.laboratoryResults; if(v==null||v===""||(typeof v==="object"&&Object.keys(v).length===0))return "-"; return typeof v==="object"?JSON.stringify(v,null,2):String(v)};
 return <div><h3 style={{marginTop:0}}>Laboratuvar</h3><p style={{color:"#64748b"}}>EK-2 sağlık kayıtlarındaki Laboratuvar verileri. Kayıt yoksa sistem bunu tıbbi işlemin yapılmadığı şeklinde yorumlamaz.</p>
