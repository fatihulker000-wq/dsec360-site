...
export default function VaccinationTab({ employee }: HealthTabProps){
 ...
 const get=(x:any)=>{const raw=x?.raw_json||{}; const v=raw.vaccination||raw.vaccinations||raw.asi||raw.asilar; if(v==null||v===""||(typeof v==="object"&&Object.keys(v).length===0))return "-"; return typeof v==="object"?JSON.stringify(v,null,2):String(v)};
 return <div><h3 style={{marginTop:0}}>Aşılar</h3><p style={{color:"#64748b"}}>EK-2 sağlık kayıtlarındaki Aşılar verileri. Kayıt yoksa sistem bunu tıbbi işlemin yapılmadığı şeklinde yorumlamaz.</p>
