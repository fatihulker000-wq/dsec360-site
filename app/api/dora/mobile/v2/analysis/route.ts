...
const DORA_MOBILE_API_KEY =
  process.env.DORA_MOBILE_API_KEY || "dsec_mobile_123";

function mobileAuthorized(req: NextRequest) {
  return req.headers.get("x-api-key") === DORA_MOBILE_API_KEY;
}
...
export async function GET(req: NextRequest) {
  try {
    ...
    // Mobil uygulama yalnız seçili firmanın Web UUID'sini gönderir.
    // Analiz motoru Web'deki /api/admin/dora-v2/analysis ile AYNI kodu kullanır.
    // Böylece App tarafında ikinci bir DORA hesaplama motoru oluşmaz.
